...
class Inmueble extends Model
{
    ...
    protected $fillable = ['tipopropiedad','idusuario','tituloanuncio','descripcion','ubicacion','precio','capacidad','habitaciones','baños','camas','niños','normas','mascotas','qr','ciudad','wifi','parqueo','cocina','refrigerador','lavaropa','piscina','privado','compartido','estado','contacto','favorito','imagen1','descripcion1','imagen2','descripcion2','imagen3','descripcion3','imagen4','descripcion4','imagen5','descripcion5'];
